"object" == typeof navigator && function (e, t) {
    ...
    var g = function () {
        ...
        return n(t, [{
            ...
            key: "get", value: function (e) {
                ...
                var n, i = e.target, a = e.changedTouches[0], s = parseFloat(i.getAttribute("min")) || 0,
                    o = parseFloat(i.getAttribute("max")) || 100, r = parseFloat(i.getAttribute("step")) || 1,
                    l = o - s, c = i.getBoundingClientRect(), u = 100 / c.width * (this.config.thumbWidth / 2) / 100;
        ...
        nullOrUndefined: b, object: k, number: function (e) {
            return y(e) === Number && !Number.isNaN(e)
        }, string: w, boolean: function (e) {
            return y(e) === Boolean
        }, function: function (e) {
            return y(e) === Function
        }, array: T, weakMap: function (e) {
            return v(e, WeakMap)
    ...
    function P(e, t, n) {
        ...
        if (e && "addEventListener" in e && !E.empty(t) && E.function(n)) {
            var r = t.split(" "), l = o;
            S && (l = {passive: s, capture: o}), r.forEach(function (t) {
    ...
    function D(e) {
        if (E.element(e)) for (var t = e.childNodes.length; t > 0;) e.removeChild(e.lastChild), t -= 1
    }
    ...
    function K() {
        ...
        E.element(e) && (e.focus({preventScroll: !0}), t && B(e, this.config.classNames.tabFocus))
    }
    ...
    var G, Z = {
        ...
        check: function (e, t, n) {
            var i = Z.isIPhone && n && te.playsinline, a = te[e] || "html5" !== t;
            return {api: a, ui: a && te.rangeInput && ("video" !== e || !Z.isIPhone || i)}
        },
                ...
                Object.defineProperty(e.media, "quality", {
                    get: function () {
                        ...
                        if (n) {
                            ...
                            }), e.media.load()), L.call(e, e.media, "qualitychange", !1, {quality: t})
                        }
                    }
                })
            }
    ...
    var de = {pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube"}, he = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    ...
    function fe(e, t) {
        if (E.string(e)) {
            var n = E.string(t), i = function () {
                return null !== document.getElementById(t)
            }, a = function (e, t) {
                e.innerHTML = t, n && i() || document.body.insertAdjacentElement("afterbegin", e)
            };
            if (!n || !i()) {
                var s = me.supported, o = document.createElement("div");
    ...
    var ke = {
        getIconUrl: function () {
            ...
            var n = ke.getIconUrl.call(this), i = "".concat(n.cors ? "" : n.url, "#").concat(this.config.iconPrefix),
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = he(e, this.config);
            return O("span", Object.assign({}, t, {class: [t.class, this.config.classNames.hidden].filter(Boolean).join(" ")}), n)
            ...
            if ("volume" !== e) {
                ...
                var i = {played: "played", buffer: "buffered"}[e], a = i ? he(i, this.config) : "";
                n.innerText = "% ".concat(a.toLowerCase())
            }
            return this.elements.display[e] = n, n
        }, createTime: function (e) {
            var t = H(this.config.selectors.display[e]), n = O("div", se(t, {
            ...
            var t = this, n = e.value, i = e.list, a = e.type, s = e.title, o = e.badge, r = void 0 === o ? null : o,
                l = e.checked, c = void 0 !== l && l, u = H(this.config.selectors.inputs[a]), d = O("button", se(u, {
                    type: "button",
                    role: "menuitemradio",
            ...
            if (this.supported.ui && E.event(e)) {
                ...
                if (e) switch (e.type) {
                    ...
                    case"progress":
                        !function (e, n) {
                            var i = E.number(n) ? n : 0, a = E.element(e) ? e : t.elements.display.buffer;
                            if (E.element(a)) {
                                a.value = i;
            ...
            if (E.element(t) && "range" === t.getAttribute("type")) {
                if (U(t, this.config.selectors.inputs.seek)) {
                    ...
                    var n = ke.formatTime(this.currentTime), i = ke.formatTime(this.duration),
            ...
            if (E.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                    n = Ce.getTracks.call(this), i = Boolean(n.length);
            ...
            var e = this.elements.settings.buttons, t = !E.empty(e) && Object.values(e).some(function (e) {
                return !e.hidden
            });
            ...
            var t = this, n = O("div", H(this.config.selectors.controls.wrapper));
            if (this.config.controls.includes("restart") && n.appendChild(ke.createButton.call(this, "restart")), this.config.controls.includes("rewind") && n.appendChild(ke.createButton.call(this, "rewind")), this.config.controls.includes("play") && n.appendChild(ke.createButton.call(this, "play")), this.config.controls.includes("fast-forward") && n.appendChild(ke.createButton.call(this, "fast-forward")), this.config.controls.includes("progress")) {
                ...
                if (i.appendChild(ke.createRange.call(this, "seek", {id: "plyr-seek-".concat(e.id)})), i.appendChild(ke.createProgress.call(this, "buffer")), this.config.tooltips.seek) {
                    var a = O("span", {class: this.config.classNames.tooltip}, "00:00");
            ...
            if (this.config.controls.includes("current-time") && n.appendChild(ke.createTime.call(this, "currentTime")), this.config.controls.includes("duration") && n.appendChild(ke.createTime.call(this, "duration")), this.config.controls.includes("mute") || this.config.controls.includes("volume")) {
                ...
                if (this.config.controls.includes("mute") && s.appendChild(ke.createButton.call(this, "mute")), this.config.controls.includes("volume")) {
                    ...
                    s.appendChild(ke.createRange.call(this, "volume", se(o, {id: "plyr-volume-".concat(e.id)}))), this.elements.volume = s
                }
                n.appendChild(s)
            }
            if (this.config.controls.includes("captions") && n.appendChild(ke.createButton.call(this, "captions")), this.config.controls.includes("settings") && !E.empty(this.config.settings)) {
                ...
                var l = O("div", {class: "plyr__menu__container", id: "plyr-settings-".concat(e.id), hidden: ""}),
                    c = O("div"), u = O("div", {id: "plyr-settings-".concat(e.id, "-home")}),
                    d = O("div", {role: "menu"});
                u.appendChild(d), c.appendChild(u), this.elements.settings.panels.home = u, this.config.settings.forEach(function (n) {
                    ...
                    var a = O("span", null, he(n, t.config)), s = O("span", {class: t.config.classNames.menu.value});
                    s.innerHTML = e[n], a.appendChild(s), i.appendChild(a), d.appendChild(i);
                    var o = O("div", {id: "plyr-settings-".concat(e.id, "-").concat(n), hidden: ""}), r = O("button", {
                        type: "button",
                        class: "".concat(t.config.classNames.control, " ").concat(t.config.classNames.control, "--back")
                    });
                    r.appendChild(O("span", {"aria-hidden": !0}, he(n, t.config))), r.appendChild(O("span", {class: t.config.classNames.hidden}, he("menuBack", t.config))), N(o, "keydown", function (e) {
            ...
            if (this.config.controls.includes("pip") && te.pip && n.appendChild(ke.createButton.call(this, "pip")), this.config.controls.includes("airplay") && te.airplay && n.appendChild(ke.createButton.call(this, "airplay")), this.config.controls.includes("download")) {
                var h = {element: "a", href: this.download, target: "_blank"}, m = this.config.urls.download;
            ...
            if (Z.isEdge && $(o), this.config.tooltips.controls) {
                var c = this.config, u = c.classNames, d = c.selectors,
                    h = "".concat(d.controls.wrapper, " ").concat(d.labels, " .").concat(u.hidden), m = z.call(this, h);
    ...
    var Ce = {
            setup: function () {
                if (this.supported.ui) if (!this.isVideo || this.isYouTube || this.isHTML5 && !te.textTracks) E.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ke.setCaptionsMenu.call(this); else {
                    ...
                    if (E.element(this.elements.captions) || (this.elements.captions = O("div", H(this.config.selectors.captions)), e = this.elements.captions, t = this.elements.wrapper, E.element(e) && E.element(t) && t.parentNode.insertBefore(e, t.nextSibling)), Z.isIE && window.URL) {
                        ...
                        Array.from(n).forEach(function (e) {
                            var t = e.getAttribute("src"), n = we(t);
                ...
                var e = this, t = Ce.getTracks.call(this, !0), n = this.captions, i = n.active, a = n.language, s = n.meta,
                ...
                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = Ce.getTracks.call(this);
                if (-1 !== e) if (E.number(e)) if (e in n) {
                    if (this.captions.currentTrack !== e) {
                        this.captions.currentTrack = e;
                        var i = n[e], a = (i || {}).language;
                        this.captions.currentTrackNode = i, ke.updateSetting.call(this, "captions"), t || (this.captions.language = a, this.storage.set({language: a})), this.isVimeo && this.embed.enableTextTrack(a), L.call(this, this.media, "languagechange")
                    }
                ...
                if (E.string(e)) {
                    ...
                    var i = Ce.getTracks.call(this), a = Ce.findTrack.call(this, [n]);
                ...
                var t, n = this, i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    a = Ce.getTracks.call(this), s = function (e) {
        ...
        }, Ee = "picture-in-picture", Se = "inline", Pe = {html5: "html5", youtube: "youtube", vimeo: "vimeo"},
        ...
        if (this.enabled) {
            ...
            E.element(e) && (e.pressed = this.active), L.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0), Z.isIos || function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                    t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                if (E.element(e)) {
                    var n = z.call(this, "button:not(:disabled), input:not(:disabled), [tabindex]"), i = n[0],
                        a = n[n.length - 1];
    ...
    var je = {
        addStyleHook: function () {
            ...
            }, 0), je.setTitle.call(this), this.poster && je.setPoster.call(this, this.poster, !1).catch(function () {
            ...
            if (E.string(this.config.title) && !E.empty(this.config.title) && (e += ", ".concat(this.config.title)), Array.from(this.elements.buttons.play || []).forEach(function (t) {
                ...
                var n = E.empty(this.config.title) ? "video" : this.config.title, i = he("frameTitle", this.config);
    ...
    function qe(e) {
        ...
        var n = a(t.split(":").map(Number), 2), i = 100 / n[0] * n[1];
        ...
        return n(t, [{
            ...
            key: "container", value: function () {
                ...
                N.call(e, n.container, "enterfullscreen exitfullscreen", function (t) {
                    var i = e.fullscreen, r = i.target, l = i.usingNative;
                    if (e.isEmbed && r === n.container) {
                        var c = "enterfullscreen" === t.type, u = s(c);
                        u.padding;
                        !function (t, n, i) {
                            if (e.isVimeo) {
                                var s = e.elements.wrapper.firstChild, o = a(t.split(":").map(Number), 2)[1],
                                    r = a(e.embed.ratio.split(":").map(Number), 2), l = r[0], c = r[1];
            ...
            key: "bind", value: function (e, t, n, i) {
                var a = this, s = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4], o = this.player,
                    r = o.config.listeners[i], l = E.function(r);
            ...
            key: "controls", value: function () {
                var e = this, t = this.player, n = t.elements, i = Z.isIE ? "change" : "input";
    ...
    }(Fe = {exports: {}}, Fe.exports), Fe.exports);
    ...
    var Ve = {
        setup: function () {
            ...
            var e = this, t = this, n = t.config.vimeo, i = Te(se({}, {
            ...
            var o,
                ...
                l = O("iframe"), c = oe(t.config.urls.vimeo.iframe, r, i);
            l.setAttribute("src", c), l.setAttribute("allowfullscreen", ""), l.setAttribute("allowtransparency", ""), l.setAttribute("allow", "autoplay");
            var u = O("div", {poster: t.poster, class: t.config.classNames.embedContainer});
    ...
    var ze, We = {
                    ...
                    events: {
                        onError: function (t) {
                            if (!e.media.error) {
                                ...
                                e.media.error = {code: n, message: i}, L.call(e, e.media, "error")
                            }
        ...
        return n(t, [{
                    ...
                    if (0 !== t && -1 !== t && t < e.player.duration) {
                        ...
                        if (E.element(n)) {
                            var i = 100 / e.player.duration * t,
                                a = O("span", {class: e.player.config.classNames.cues});
            ...
            key: "onAdEvent", value: function (e) {
                var t = this, n = this.player.elements.container, i = e.getAd(), a = e.getAdData(), s = function (e) {
        ...
        return n(t, [{
            ...
            key: "render", value: function () {
                this.elements.thumb.container = O("div", {class: this.player.config.classNames.previewThumbnails.thumbContainer}), this.elements.thumb.imageContainer = O("div", {class: this.player.config.classNames.previewThumbnails.imageContainer}), this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
                var e = O("div", {class: this.player.config.classNames.previewThumbnails.timeContainer});
                this.elements.thumb.time = O("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.container.appendChild(e), this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = O("div", {class: this.player.config.classNames.previewThumbnails.scrubbingContainer}), this.player.elements.wrapper.appendChild(this.elements.scrubbing.container)
            }
        }, {
                        ...
                        if (t.showingThumbFilename === a) {
                            ...
                            s.forEach(function (e) {
                                ...
                                if (n !== a && !t.loadedImages.includes(n)) {
                                    ...
                                    var s = t.thumbnails[0].urlPrefix + n, r = new Image;
        ...
        insertElements: function (e, t) {
            var n = this;
            E.string(t) ? j(e, this.media, {src: t}) : E.array(t) && t.forEach(function (t) {
                j(e, n.media, t)
            })
        }, change: function (e) {
            var t = this;
            ae(e, "sources.length") ? (ne.cancelRequests.call(this), this.destroy.call(this, function () {
                ...
                var n = e.sources, i = e.type, s = a(n, 1)[0], o = s.provider, r = void 0 === o ? Pe.html5 : o,
        ...
        function t(n, i) {
            ...
            if (e(this, t), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = te.touch, this.media = n, E.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || E.nodeList(this.media) || E.array(this.media)) && (this.media = this.media[0]), this.config = se({}, Ae, t.defaults, i || {}, function () {
                ...
                speed: [],
                quality: []
            }, this.debug = new xe(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", te), !E.nullOrUndefined(this.media) && E.element(this.media)) if (this.media.plyr) this.debug.warn("Target already setup"); else if (this.config.enabled) if (te.check().api) {
                ...
                this.supported = te.check(this.type, this.provider, this.config.playsinline), this.supported.api ? (this.eventListeners = [], this.listeners = new De(this), this.storage = new me(this), this.media.plyr = this, E.element(this.elements.container) || (this.elements.container = O("div", {tabindex: 0}), I(this.media, this.elements.container)), je.addStyleHook.call(this), Ke.setup.call(this), this.config.debug && N.call(this, this.elements.container, this.config.events.join(" "), function (e) {
        ...
        return n(t, [{
            ...
            key: "poster", set: function (e) {
                this.isVideo ? je.setPoster.call(this, e, !1).catch(function () {
